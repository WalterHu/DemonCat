    ...
    extends TlsProtocol
{
        ...
        throws IOException
    {
        ...
        Log.d(TlsClientProtocol.class.getSimpleName(), "handleHandshakeMessage -> type: " +
                type + ", connection_state: " + this.connection_state);
...
//                    throw new TlsFatalAlert(AlertDescription.illegal_parameter);
        ...
        throws IOException
    {
        ...
        // Added by hubohua for OCSP Stapling feature begin
        Log.d(TlsClientProtocol.class.getSimpleName(), "sendClientHelloMessage -> clientExtensions: " +
