    ...
    implements TlsClient
{
        ...
        throws IOException
    {
        ...
        Log.d(AbstractTlsClient.class.getSimpleName(), "getClientExtensions -> statusRequest: " +
        ...
        if (statusRequest != null)
        {
            ...
            // Added by hubohua for OCSP Stapling feature begin
            Log.d(AbstractTlsClient.class.getSimpleName(), "getClientExtensions -> clientExtensions: " +
                    clientExtensions);
            // Added by hubohua for OCSP Stapling feature end
        }
