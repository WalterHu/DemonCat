    ...
    extends X509ExtendedKeyManager
{
    ...
    private final Map<String, PrivateKeyEntry> keys = new HashMap<String, PrivateKeyEntry>();
        ...
        throws GeneralSecurityException
    {
        ...
        for (Enumeration<String> en = keyStore.aliases(); en.hasMoreElements();)
        {
            ...
            {
                PrivateKeyEntry kEntry = (PrivateKeyEntry)keyStore.getEntry(eName, storeBuilder.getProtectionParameter(eName));
