...
package com.demoncat.dcapp.widget.scrolllayout;
...
import com.demoncat.dcapp.widget.scrolllayout.content.ContentScrollView;
...
public class ScrollLayout extends FrameLayout {
    ...
    private RecyclerView.OnScrollListener mOnRecycleScrollListener = new RecyclerView.OnScrollListener() {
        @Override
    ...
    /**
     * Used for ContentScrollView mostly for out of screen TextView
     * @param scrollView
     */
    ...
    /**
     * Used for ScrollRecycleView
     * @param recycleView
     */
    public void setAssociateRecycleViewScrollListener(ScrollRecycleView recycleView) {
        recycleView.setOnScrollListener(mOnRecycleScrollListener);
        updateRecyclerViewScrollState(recycleView);
    }

    private void updateRecyclerViewScrollState(RecyclerView recyclerView) {
        // no child in recycler view
        // set could draggable
        if (recyclerView.getChildCount() == 0) {
            setDraggable(true);
        } else {
            // if first child is at the very top
            // set could draggable
